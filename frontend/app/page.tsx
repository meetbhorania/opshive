...
const HEADLINE_WORDS = ['The', 'autonomous', 'AI', 'team', 'for', 'anyone', 'building', 'a', 'company.']
  ...
  return (
    <main style={{ fontFamily: 'system-ui, sans-serif', background: '#050810', color: '#fff', overflowX: 'hidden' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
          {[['How it works', '#how-it-works'], ['Features', '#features'], ['Pricing', '#pricing']].map(([label, href]) => (
            <a key={label} href={href} style={{ fontSize: '14px', color: 'rgba(255,255,255,0.55)', textDecoration: 'none', transition: 'color 0.2s' }}
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '820px' }}>
          ...
          <h1 style={{
            ...
            letterSpacing: '-2.5px', margin: '0 0 24px', color: '#fff'
          }}>
            {HEADLINE_WORDS.map((word, i) => (
              <AnimatedWord key={i} word={word} delay={0.4 + i * 0.08} />
            ))}
          </h1>
        ...
        <div style={{ maxWidth: '1050px', margin: '0 auto' }}>
          ...
          >
            ...
            <h2 style={{
              ...
              color: '#fff', margin: '12px 0 0', lineHeight: '1.1'
            }}>
            ...
            {[
              {
                number: '01',
                accent: '#639922',
                title: 'You type. Agents listen.',
                stat: '< 60s',
                statLabel: 'to full setup',
                body: 'Tell us your company name, industry and what you\'re building. No forms. No complexity. Just describe it like you would to a colleague.',
              },
              {
                number: '02',
                accent: '#378ADD',
                title: 'Six experts wake up.',
                stat: '6',
                statLabel: 'specialised agents',
                body: 'Sales, Finance, Marketing, Support, Ops and CEO agents each configure themselves specifically for your company. Powered by real Gemini AI reasoning.',
              },
              {
                number: '03',
                accent: '#22C55E',
                title: 'They run. You build.',
                stat: '24/7',
                statLabel: 'always monitoring',
                body: 'Agents monitor your operations in real time, talk to each other via A2A protocol, and act autonomously. You make one decision. They handle everything else.',
              }
            ].map((step, i) => (
              <SpotlightCard key={i} delay={i * 0.15} accent={step.accent}>
                ...
                <div style={{ marginBottom: '20px' }}>
                  <div style={{
                    ...
                    color: step.accent, letterSpacing: '-2px',
                    lineHeight: '1', marginBottom: '4px'
                  }}>
                    {step.stat}
                  </div>
                  <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.35)', letterSpacing: '0.04em' }}>
                    {step.statLabel}
                  </div>
                </div>
                ...
                <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.42)', lineHeight: '1.75', margin: 0 }}>
                  {step.body}
                </p>
            ...
            {['Sales · Alex', 'Finance · Morgan', 'Marketing · Jamie', 'Support · Riley', 'Ops · Sam', 'CEO · Dana'].map((agent, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <div style={{
                  ...
                  fontSize: '12px', color: '#a8d86e', fontWeight: '500'
                }}>
                  {agent}
                </div>
      ...
      <section id="features" style={{ background: '#050810', padding: '120px 24px', position: 'relative' }}>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <motion.div
            ...
            style={{ textAlign: 'center', marginBottom: '72px' }}
          >
            <span style={{ fontSize: '11px', color: '#378ADD', letterSpacing: '0.15em', textTransform: 'uppercase', fontWeight: '600' }}>
              Features
            </span>
            <h2 style={{
              fontSize: 'clamp(32px, 5vw, 54px)',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }}>
            ...
            <SpotlightCard delay={0} accent="#639922" style={{ gridColumn: 'span 2' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '24px' }}>
                <span style={{ fontSize: '10px', color: '#639922', letterSpacing: '0.12em', textTransform: 'uppercase', fontWeight: '600' }}>
                  Agent Intelligence
                </span>
                <div style={{
                  background: 'rgba(99,153,34,0.12)', border: '1px solid rgba(99,153,34,0.25)',
                  borderRadius: '20px', padding: '3px 12px',
                  fontSize: '11px', color: '#a8d86e'
                }}>
                  Live
                </div>
              </div>
              ...
              <h3 style={{ fontSize: '24px', fontWeight: '700', color: '#fff', margin: '0 0 12px', letterSpacing: '-0.5px' }}>
                Not one AI trying to do everything.
              </h3>
              <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.4)', lineHeight: '1.75', margin: 0 }}>
                Six domain experts — each trained to reason about their specific area. Sales knows pipeline. Finance knows cash flow. Support knows tickets. They don't overlap. They collaborate.
              </p>
            </SpotlightCard>
            ...
            <SpotlightCard delay={0.1} accent="#378ADD">
              ...
              <h3 style={{ fontSize: '18px', fontWeight: '700', color: '#fff', margin: '0 0 10px', letterSpacing: '-0.4px' }}>
                Agents talk to each other.
              </h3>
              <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', lineHeight: '1.7', margin: 0 }}>
                When Marketing spots a competitor price cut, it messages Sales directly. Real agent-to-agent communication. No human relay.
              </p>
            </SpotlightCard>
            ...
            <SpotlightCard delay={0.2} accent="#EF9F27">
              ...
              <h3 style={{ fontSize: '18px', fontWeight: '700', color: '#fff', margin: '0 0 10px', letterSpacing: '-0.4px' }}>
                One brain synthesising everything.
              </h3>
              <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', lineHeight: '1.7', margin: 0 }}>
                Dana Williams reads every signal from every agent and delivers a 60-second war room brief. Every. Single. Time.
              </p>
            </SpotlightCard>
            ...
            <SpotlightCard delay={0.3} accent="#E24B4A" style={{ gridColumn: 'span 2' }}>
              <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '24px' }}>
                <span style={{ fontSize: '10px', color: '#E24B4A', letterSpacing: '0.12em', textTransform: 'uppercase', fontWeight: '600' }}>
                  Autonomous Actions
                </span>
              </div>
              ...
              <h3 style={{ fontSize: '22px', fontWeight: '700', color: '#fff', margin: '0 0 12px', letterSpacing: '-0.5px' }}>
                They act. You approve one thing.
              </h3>
              <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.4)', lineHeight: '1.75', margin: 0 }}>
                Agents don't just raise flags. They draft emails, escalate to engineering, update pipelines. When the CEO flags something suspicious — that's the one moment you step in.
              </p>
            </SpotlightCard>
            ...
            <SpotlightCard delay={0.4} accent="#22C55E">
              ...
              <h3 style={{ fontSize: '18px', fontWeight: '700', color: '#fff', margin: '0 0 10px', letterSpacing: '-0.4px' }}>
                Built for your company. Not every company.
              </h3>
              <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', lineHeight: '1.7', margin: 0 }}>
                Describe what you're building. Agents configure around your industry, team size and goals.
              </p>
            </SpotlightCard>
            ...
            {[
              {
                ...
                price: '£0',
                period: 'forever',
                description: 'Try OpsHive with no commitment.',
                accent: 'rgba(255,255,255,0.4)',
                features: [
                  '1 company',
                  '3 agents',
                  '5 crisis triggers per day',
                  'CEO war room brief',
                  'A2A message feed',
                ],
              ...
              },
              {
                ...
                price: '£29',
                period: '/month',
                description: 'Everything a solo founder needs.',
                accent: '#639922',
                features: [
                  '1 company',
                  'All 6 agents',
                  'Unlimited crisis triggers',
                  'CEO war room brief',
                  'Agent actions panel',
                  'CEO chat — ask anything',
                  'Custom company scenario',
                ],
                cta: 'Launch OpsHive',
                popular: true,
              },
              ...
              },
              {
                ...
                price: 'POA',
                period: '',
                description: 'Custom agents for large teams.',
                accent: '#EF9F27',
                features: [
                  'Unlimited companies',
                  'Custom agent builds',
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    border: plan.popular
                      ? '1px solid rgba(99,153,34,0.4)'
                      : `1px solid ${hovered ? plan.accent + '40' : 'rgba(255,255,255,0.07)'}`,
                    borderRadius: '20px',
                    padding: '36px 28px',
                    position: 'relative',
                    overflow: 'hidden',
                ...
                >
                  ...
                  {plan.popular && (
                    <div style={{
                      ...
                      fontSize: '10px', color: '#a8d86e', fontWeight: '600',
                  ...
                  {/* Plan name */}
                  <div style={{ fontSize: '13px', fontWeight: '600', color: plan.accent, marginBottom: '16px', letterSpacing: '0.04em' }}>
                    {plan.name}
                  </div>

                  {/* Price */}
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: '4px', marginBottom: '8px' }}>
                    <span style={{ fontSize: '48px', fontWeight: '700', color: '#fff', letterSpacing: '-2px', lineHeight: '1' }}>
                      {plan.price}
                    </span>
                  ...
                  <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', margin: '0 0 28px', lineHeight: '1.5' }}>
                    {plan.description}
                  </p>
      ...
      <section style={{ background: '#050810', padding: '140px 24px', position: 'relative', textAlign: 'center' }}>
        <div style={{
          position: 'absolute', inset: 0,
          background: 'radial-gradient(ellipse at 50% 50%, rgba(99,153,34,0.06) 0%, transparent 70%)'
        }} />
        <div style={{ position: 'relative', zIndex: 10, maxWidth: '700px', margin: '0 auto' }}>
          ...
          >
            ...
            <p style={{
              ...
              lineHeight: '1.7', margin: '0 auto 48px', maxWidth: '480px'
            }}>
      ...
      <footer style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ maxWidth: '260px' }}>
                ...
                <div style={{ display: 'flex', gap: '4px' }}>
                  {[0, 1, 2].map(i => (
                    <div key={i} style={{
                      ...
                      background: '#639922', opacity: 1 - i * 0.25
                    }} />
                  ))}
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  <a href="https://meetbhorania.com" target="_blank" rel="noopener noreferrer" style={{
                  ...
                  <a href="https://www.linkedin.com/in/manansuthar/" target="_blank" rel="noopener noreferrer" style={{
                    fontSize: '13px', color: 'rgba(255,255,255,0.5)',
                    textDecoration: 'none', fontWeight: '500',
                    transition: 'color 0.2s'
                  }}
            ...
            <div style={{ display: 'flex', gap: '80px', flexWrap: 'wrap' }}>
              ...
              <div>
                ...
                {[
                  ['Meet Bhorania', 'https://meetbhorania.com'],
                  ['LinkedIn — Meet', 'https://www.linkedin.com/in/meetbhorania'],
                  ['Manan Suthar', 'https://www.linkedin.com/in/manansuthar/'],
                  ['LinkedIn — Manan', 'https://www.linkedin.com/in/manansuthar/'],
                ].map(([label, href]) => (
          ...
          {/* Bottom row — no line, just spaced text */}
          <div style={{
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'space-between',
            ...
            <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.14)', letterSpacing: '0.02em' }}>
              © 2026 OpsHive. Built with ♥ in London.
            </span>
            <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.14)' }}>
              Powered by Google ADK · Gemini AI · Vertex AI
            </span>
          </div>
        </div>
      </footer>
